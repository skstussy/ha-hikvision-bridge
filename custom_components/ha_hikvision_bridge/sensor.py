...
class HikvisionCameraInfoSensor(BaseCameraEntity, SensorEntity):
    ...
    def extra_state_attributes(self):
        ...
        return {
            ...
            "model": cam.get("model"),
            "manufacturer": cam.get("manufacturer") or "Hikvision",
...
class HikvisionNVRSystemInfoSensor(BaseNVREntity, SensorEntity):
    ...
    def extra_state_attributes(self):
        ...
        return {
            ...
            "build_number": nvr.get("build_number"),
            "device_type": nvr.get("device_type"),
            "disk_mode": nvr.get("disk_mode") or storage.get("disk_mode"),
            "work_mode": nvr.get("work_mode") or storage.get("work_mode"),
            "disk_count": nvr.get("disk_count", storage.get("disk_count", 0)),
            "healthy_disks": nvr.get("healthy_disks", storage.get("healthy_disks", 0)),
            "failed_disks": nvr.get("failed_disks", storage.get("failed_disks", 0)),
            "total_capacity_mb": nvr.get("total_capacity_mb", storage.get("total_capacity_mb")),
            "free_capacity_mb": nvr.get("free_capacity_mb", storage.get("free_capacity_mb")),
            "used_capacity_mb": nvr.get("used_capacity_mb", storage.get("used_capacity_mb")),
            "hdds": nvr.get("hdds", storage.get("hdds", [])),
