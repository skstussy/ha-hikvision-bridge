...
CATALOG = [
    ...
    {"id": "ptz_proxy_channel", "group": "ptz", "label": "PTZ proxy channel", "path": "/ISAPI/ContentMgmt/PTZCtrlProxy/channels/{channel_id}", "method": "GET", "probe": "read", "context": "channel"},
    {"id": "ptz_proxy_channel_capabilities", "group": "ptz", "label": "PTZ proxy channel capabilities", "path": "/ISAPI/ContentMgmt/PTZCtrlProxy/channels/{channel_id}/capabilities", "method": "GET", "probe": "read", "context": "channel"},
